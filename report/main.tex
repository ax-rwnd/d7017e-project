...
\end{titlepage}
 ...
 At the end of the development, the site seemed to be work for the use-cases of simpler programming courses. However, some of the core features that are essential to deeper analysis still need to be implemented.
